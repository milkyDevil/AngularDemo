...
export const registerSuccess = createAction(REGISTER_SUCCESS, props<{ message: string, resulttype: string }>());

export const REGISTER_FAILURE = '[auth] register failure';
export const registerFailure = createAction(REGISTER_FAILURE, props<{ message: string, resulttype: string }>());
